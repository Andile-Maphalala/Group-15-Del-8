    ...
    public class AdminController : ApiController
    {
        ...
        public IHttpActionResult PutjobMaster(RENTAL_AGREEMENT due)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    mail.Subject = "Inturbidus: Deposit due extended";
        ...
        public IHttpActionResult PutexcptMaster(RENTAL_AGREEMENT due)
        {
            ...
            try
            {
                ...
                {
                    dues.RENTALAGREEMENTID = due.RENTALAGREEMENTID;
                    dues.RENTALENDDATE = due.RENTALENDDATE;
        ...
        public IHttpActionResult FailInspect(INSPECTION data)
        {
            ...
            try
            {
                ...
                JOB newJob = new JOB();
                newJob.RENTALAGREEMENTID = data.RENTALAGREEMENTID;
                newJob.JOBTYPEID = 2;
                ...
                var clientID = db.RENTAL_AGREEMENT.Where(nn => nn.RENTALAGREEMENTID == data.RENTALAGREEMENTID).Select(vvs => vvs.CLIENTID).FirstOrDefault();
                var referenceNo = db.RENTAL_AGREEMENT.Where(nn => nn.RENTALAGREEMENTID == data.RENTALAGREEMENTID).Select(vvs => vvs.REFERENCE_NO).FirstOrDefault();
        ...
        public IHttpActionResult PutRentalATAgreement(RENTAL_AGREEMENT due)
        {
            ...
            try
            {
                ...
                if (dues != null)
                {
                    ...
                    dues.RENTALSTATUSID = 1; //Change the rental end date instead
                    var prop = db.PROPERTies.Find(due.PROPERTYID);
                    prop.AVAILABLEDATE = due.TerminateRentalDate;
                ...
                try
                {
                    ...
                    mail.Body = "Good day " + cln.NAME + " " + cln.SURNAME + "\n Your Rental Termination request has been Accepted. Your rental agreement for the property: " + prop.ADDRESS + " will be terminated on the termination date provided.";
