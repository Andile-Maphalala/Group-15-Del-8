            ...
            try
            {
                foreach (var agent in db.AGENTs.ToList())
                {
                    ...
                    foreach (var prop in proplist)
                    {
                        ...
                        objLocation.PROPERTYID = prop.PROPERTYID;
                        objLocation.AREA = prop.AREA.AREANAME;
                        objLocation.CITY = prop.AREA.CITY.CITYNAME;
                        objLocation.PROVINCE = prop.AREA.CITY.PROVINCE.PROVINCENAME;
                        objLocation.ADDRESS = prop.ADDRESS;
