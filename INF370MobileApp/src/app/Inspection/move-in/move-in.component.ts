...
@ViewChild('success') success : any;
  ...
  //private formbulider: FormBuilder,private InspectionService:InspectionService,private _Router : Router ,
  //private httpService: HttpClient,private adminService:AdminService,private manService:MaintenanceService)
  ngOnInit(): void {  
...
this.modalService.dismissAll();
  ...
  loadSchedule(){
this.InspectionService.getInspectionById(window.sessionStorage.getItem("EmployeeID")).subscribe(ii=>{ debugger;
