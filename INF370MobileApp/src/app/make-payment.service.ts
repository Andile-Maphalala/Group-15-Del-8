...
export class MakePaymentService {
  ...
  sendTermination(Terminate: Terminate): Observable<Terminate> {   debugger;
    ...
    return this.http.post<Terminate>('http://localhost:30135/Api/Terminate/SendTerminateEmail',  
...
sendExtension(Terminate: Terminate): Observable<Terminate> {   debugger;
  const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json'}) };  
  return this.http.post<Terminate>('http://localhost:30135/Api/Extend/SendExtendEmail',  
  Terminate, httpOptions);  
}  
//////////////////////////////////////////////////////////////////////////////////////
...
sendMaintenance(Terminate: Terminate): Observable<Terminate> {   debugger;
  const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json'}) };  
  return this.http.post<Terminate>('http://localhost:30135/Api/RequestMaintenance/SendMaintenanceEmail',  
  Terminate, httpOptions);  
}  
