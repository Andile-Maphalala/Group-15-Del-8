...
export class AssignComplaintComponent implements OnInit {
  ...
  loadAllComplaints() {  
    this.allemployees = this.complaintservice.getAllEmployees(); 
 }
 ...
 Assign(EmpID : number)
 {
  ...
  this.complaintservice.Assign(this.myEmployee);
  window.alert("You have successfully assigned a complaint");
 }
