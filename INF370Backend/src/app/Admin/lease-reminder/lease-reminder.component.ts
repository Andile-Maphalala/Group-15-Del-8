...
@Component({
  selector: 'app-lease-reminder',
  templateUrl: './lease-reminder.component.html',
  styleUrls: ['./lease-reminder.component.css']
})
export class LeaseReminderComponent implements OnInit {
  dataSaved = false;  
  clientForm: any;
  client: Observable<Agreements[]>;  
