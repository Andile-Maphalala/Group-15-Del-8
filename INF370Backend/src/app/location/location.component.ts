...
debugger;
  ...
  deleteCity(cityId: string) {  
    ...
    this.ApiService.deleteCityById(cityId).subscribe(getgid => {  
console.log(getgid); debugger;

if(getgid.toString()=="false")
{
window.alert("This city has areas attached to it and cannot be deleted")
...
debugger;
  ...
  deleteArea(areaId: string) {  
    if (confirm("Are you sure you want to delete this ?")) {   
    this.ApiService.deleteAreaById(areaId).subscribe(getgid => {  
      if(getgid.toString()=="false")
{
window.alert("This area has properties attached to it and cannot be deleted")
...
deleteProvince(provinceId: string) {  
  if (confirm("Are you sure you want to delete this ?")) {   
  this.ApiService.deleteProvinceById(provinceId).subscribe(getgid => {  
    if(getgid.toString()=="false")
    {
    window.alert("This province has cities attached to it and cannot be deleted")
